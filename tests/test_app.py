...
# "monkeypatch" is a special built-in pytest fixture that can install mocks
def test_posted_image_gets_saved(client, monkeypatch):
    ...
    # ...it must return a 201 code, save the file, and return
    # the image's resource location
